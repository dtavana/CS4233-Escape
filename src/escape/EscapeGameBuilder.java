...
public class EscapeGameBuilder
{
    ...
    {
		EscapeGameManagerImpl manager;
    	if(this.getGameInitializer().getCoordinateType() == Coordinate.CoordinateType.SQUARE) {
    		// Instantiate a square game
			manager = new EscapeGameManagerImplSquare(this.getGameInitializer());
		}
		else {
			// Instantiate a hex game
			manager = new EscapeGameManagerImplHex(this.getGameInitializer());
		}
